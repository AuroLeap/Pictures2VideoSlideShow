...
//! MP4 per definition — and LLR-065: `build --output <name>` restricts the run
...
// Verifies: SR-017, LLR-065 — `build --output <name>` builds ONLY the named
...
// Verifies: SR-017, LLR-065 — an unknown `--output` name fails fast (non-zero,
